...
public enum spell_attribute_types { health, energy, damage, money, penalty }
    ...
    public void actualizeSpells()
    {
        ...
        */
        ...
        spells.AddRange(new List<Spell>()
        {
            ...
            {new Spell(2, "Enraged blow", spell_types.damage, spell_attribute_types.damage, spell_attribute_value_types.number, 15, 15, 10, "Spell_icons/2", "attack_2", 1, 3, 0)},
            {new Spell(3, "Fast regeneration", spell_types.heal, spell_attribute_types.health, spell_attribute_value_types.number, 20, 20, 10, "Spell_icons/3", "heal_1", 1, 5, 0)},
            {new Spell(4, "Energy surge", spell_types.support, spell_attribute_types.energy, spell_attribute_value_types.number, 25, 25, 10, "Spell_icons/4", "resource_1", 3, 5, 0)},
            ...
            {new Spell(6, "Rested state", spell_types.passive, spell_attribute_types.energy, spell_attribute_value_types.number, 50, 100, 0, "Spell_icons/6", null, 5, 3, 0)},
            ...
            {new Spell(9, "Inspiration", spell_types.support,  spell_attribute_types.energy, spell_attribute_value_types.percentage, 50, 50, 10, "Spell_icons/9", "resource_1", 7, 1, 0)},
        ...
        foreach (var spell in spells)
        {
            ...
            if (spell.type == spell_types.damage)
            {
                if (spell.attribute_type == spell_attribute_value_types.percentage)
                {
                    ...
                    spell.description = "Deals +" + spell.attribute + "% of the target's health damage to the <b>target<b>.";

                }
                else if (spell.attribute_type == spell_attribute_value_types.number)
                {
                    spell.lastAttribute = spell.attribute;
                    spell.attribute = Convert.ToInt32((spell.starterAttribute + _characterStats.Player_damage) * _multiplier);
            ...
            if (spell.type == spell_types.support)
            {
                if (spell.attribute_type == spell_attribute_value_types.percentage)
                {
                    spell.lastAttribute = spell.attribute;
                    spell.attribute = Convert.ToInt32(spell.starterAttribute * _multiplier);
                    spell.description = "You regain +" + spell.attribute + "% energy.";
                }
                else if (spell.attribute_type == spell_attribute_value_types.number)
                {
                    spell.lastAttribute = spell.attribute;
            ...
            if (spell.type == spell_types.passive)
            {
                if (spell.attribute_type == spell_attribute_value_types.number)
                {
                    ...
                    else if (spell.attribute_name == spell_attribute_types.energy)
                    {
                        spell.description = "Grants you +" + spell.attribute + " energy passively.";
                    }
...
public class Spell
{
    ...
    public void passiveActivate()
    {
        ...
        if (attribute_name == spell_attribute_types.health)
        {
            ...
            {
                _characterStats.Player_max_health -= lastAttribute;
            }
            _characterStats.Player_max_health += attribute;
        }
        else if (attribute_name == spell_attribute_types.energy)
        {
            if (current_spell_points >= 2)
            {
                _characterStats.Player_max_resource -= lastAttribute;
            }
            _characterStats.Player_max_resource += attribute;
        }
        else if (attribute_name == spell_attribute_types.damage)
        {
            if (current_spell_points >= 2)
            {
                _characterStats.Player_damage -= lastAttribute;
            }
            _characterStats.Player_damage += attribute;
        }
        else if (attribute_name == spell_attribute_types.money)
        {
            if (current_spell_points >= 2)
            {
                _characterStats.Player_plus_money_rate -= lastAttribute;
            }
            _characterStats.Player_plus_money_rate += attribute;
        }
        else if (attribute_name == spell_attribute_types.penalty)
        {
            if (current_spell_points >= 2)
            {
                _characterStats.Player_penalty_rate -= lastAttribute;
            }
            _characterStats.Player_penalty_rate += attribute;
        }
    }
    ...
    public void Activate(GameObject target)
    {
        ...
        {
            if (target.GetComponent<Enemy_script>().enemy_health > 0)
            {
                ...
                else
                {
                    if (attribute_type == spell_attribute_value_types.percentage)
                    {
                        ...
                        target.GetComponent<Character_manager>().damage_text.GetComponent<Text_animation>()
                        .startAnim("-" + target.GetComponent<Enemy_script>().getPercentOfHealth(attribute), 0.05f);
                ...
                GameObject Player_character = GameObject.Find("Character");
                Player_character.GetComponent<Character_manager>().damage_text.GetComponent<Text_animation>().startAnim("-" + resource_cost + " energy", 0.05f);
                Player_character.GetComponent<Character_manager>().damage_text.GetComponent<Animator>().Play("resource_1");
        ...
        if (type == spell_types.heal)
        {
            ...
            if (attribute_type == spell_attribute_value_types.percentage)
            {
                ...
                Player_character.GetComponent<Character_manager>().damage_text.GetComponent<Text_animation>()
                .startAnim("+" + target.GetComponent<Character_stats>().getPercentOfHealth(attribute) + " health", 0.05f);
            ...
            else
            {
                ...
                Player_character.GetComponent<Character_manager>().damage_text.GetComponent<Text_animation>().startAnim("+" + attribute + " health", 0.05f);
                GameObject.Find("Health_bar").GetComponent<Bar_script>().updateHealthAddition();
            }
            Player_character.GetComponent<Character_manager>().damage_text.GetComponent<Animator>().Play(animation);
        }
        ...
        if (type == spell_types.support)
        {
            ...
            if (attribute_type == spell_attribute_value_types.percentage)
            {
                ...
                Player_character.GetComponent<Character_manager>().damage_text.GetComponent<Text_animation>().startAnim("+" + target.GetComponent<Character_stats>().getPercentOfResource(attribute) + " energy", 0.05f);
            ...
            else
            {
                ...
                Player_character.GetComponent<Character_manager>().damage_text.GetComponent<Text_animation>().startAnim("+" + attribute + " energy", 0.05f);
                GameObject.Find("Resource_bar").GetComponent<Bar_script>().updateResourceAddition();
            }
            Player_character.GetComponent<Character_manager>().damage_text.GetComponent<Animator>().Play(animation);
        }
