    ...
    void Awake()
    {
        ...
        */
        spells.AddRange(new List<Spell>()
        {
            ...
            {new Spell(1, "Attack", spell_types.damage, "warrior", "Deals ", spell_attribute_types.damage, spell_attribute_value_types.number, 0, 0, 10, "Spell_icons/5", "attack_1", 1, 5, 2)},
