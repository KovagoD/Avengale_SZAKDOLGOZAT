...
public class Spell
{
    ...
    public void setupAttributes()
    {
        if (type == "attack")
        {
            this.attribute = GameObject.Find("Game manager").GetComponent<Character_stats>().Local_physical_damage;
        }

        if (type == "healing")
        {
            this.attribute = GameObject.Find("Game manager").GetComponent<Character_stats>().Local_max_health;
        }

        if (type == "buff")
        {
            this.attribute = GameObject.Find("Game manager").GetComponent<Character_stats>().Local_max_resource;
        }
    }
}